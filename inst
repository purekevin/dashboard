...
wget -q https://raw.githubusercontent.com/purekevin/dashboard/master/grafana.db
...
printf "API connection to the FlashBlade.  You will be prompted if you want to \n"
printf "continue connecting:\n"
printf "Enter ${RED}'yes'${GREEN} when promted ${NC}'(yes/no)' \n"
printf "\n${GREEN}Next you will be prompted for a password.  \n"
printf "Enter ${RED}'pureuser'${GREEN} as the password.${NC}\n\n\n"
echo
echo
#wget -q https://raw.githubusercontent.com/purekevin/dashboard/master/start-fb-exporter
...
wget -q https://raw.githubusercontent.com/purekevin/dashboard/master/mk-empty-files.sh
wget -q https://raw.githubusercontent.com/purekevin/dashboard/master/mk-data-files.sh
